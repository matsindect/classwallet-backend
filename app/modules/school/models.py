...
class School(Base):
    ...
    merchant_code: Mapped[str | None] = mapped_column(String(100), nullable=True)
    biller_code: Mapped[str | None] = mapped_column(String(100), nullable=True)
    account_identifier: Mapped[str | None] = mapped_column(String(100), nullable=True)
    academic_term_config: Mapped[str | None] = mapped_column(Text, nullable=True)
